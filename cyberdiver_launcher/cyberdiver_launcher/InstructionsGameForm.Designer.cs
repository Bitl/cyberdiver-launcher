...
namespace cyberdiver_launcher
{
	partial class InstructionsGameForm
	{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(InstructionsGameForm));
			...
			this.label2.Text = "To start the game, press F3 2 times on your keyboard.";
			...
			this.label3.Text = "To navigate the interface, use the arrow keys to move around the interface, and p" +
			"ress F2 to select an option.";
